...
export const ROUTE_META: RouteMeta[] = [
  ...
  { id: 'privacy', path: '/privacy', layout: 'public', access: 'public', titleKey: 'pages.privacy.title', descriptionKey: 'pages.privacy.description' },
  { id: 'login', path: '/login', layout: 'auth', access: 'public-only', titleKey: 'pages.login.title', descriptionKey: 'pages.login.description' },
  { id: 'register', path: '/register', layout: 'auth', access: 'public-only', titleKey: 'pages.register.title', descriptionKey: 'pages.register.description' },
